...
// authenticationRequiredResponse is used to send a 401 status unauthorized status code and an appropriate error message
func (app *application) authenticationRequiredResponse(w http.ResponseWriter, r *http.Request)  {
	message := "you must be authenticated to access this resource"
	app.errorResponse(w, r, http.StatusUnauthorized, message)
}

// inactiveAccountResponse is used to send a 403 status forbidded status code and an appropriate error message
